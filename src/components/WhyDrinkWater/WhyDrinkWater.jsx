...
import { ContainerWDW, TitleWDW, ListWDW, ItemWDW, Point, TextWDW } from './WhyDrinkWater.styled';
    ...
    return (
        <ContainerWDW>
            ...
            <ListWDW>
                ...
                <ItemWDW>
                    <Point></Point>
                    <TextWDW>Maintaining an immune system capable of resisting disease</TextWDW>
                </ItemWDW>
            </ListWDW>
        </ContainerWDW>
    )
